...
void delete_To_pos(Node* Head,int pos){
      if (pos == 1)
    {
        cout << "Please Use system 6 to add Head to Node"<< endl;
        return;
    }
    Node* tmp = Head;
    for (int i = 1; i < pos - 1; i++)
...
// Create function that delete the head of the node 
void delete_To_Head(Node* &Head){
    // Store the old head
    if(Head == NULL){
        cout << "Invalil head unavailable ";
        return;
    }
    Node* Old_Head = Head;
    Head = Head->next;
...
int main(){
    ...
    {
        cout << endl << endl;
        cout << "System No: 1] Insert Node On Tail"<< endl; // Handeled the error BY Head controll
        cout << "System No: 2] Insert Node On Position"<< endl;// Handeled the error if else
        cout << "System No: 3] Print Node Values"<< endl; // Have no errors
        cout << "System No: 4] Insert Node On Head"<< endl; /// Have no erros
        cout << "System No: 5] Delete Node By Position"<< endl;// Handeled the error if else two 
        cout << "System No: 6] Delete Node Head"<< endl;
        ...
        else if (system_input == 6)
        {
            cout << "Loading System 6........"<<endl;
            delete_To_Head(Head);
        }
